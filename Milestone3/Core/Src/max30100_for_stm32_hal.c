...
/**
 * @brief max30100 initiation function.
 *
...
/**
 * @brief Write buffer of buflen bytes to a register of the max30100.
 *
 * @param obj Pointer to max30100_t object instance.
...
/**
 * @brief Read buflen bytes from a register of the max30100 and store to buffer.
 *
 * @param obj Pointer to max30100_t object instance.
 ...
 *
 * @param obj Pointer to max30100_t object instance.
 * @param slot1 Slot 1 mode enum (max30100_multi_led_ctrl_t).
 * @param slot2 Slot 2 mode enum (max30100_multi_led_ctrl_t).
 */
